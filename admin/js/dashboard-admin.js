        ...
        var myLineChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    pointHitRadius: 10,
                    pointBorderWidth: 2,
                    data: [500000, 750000, 600000, 900000, 800000, 1200000, 1100000],
                }],
            },
            options: {
                ...
                scales: {
                    ...
                    yAxes: [{ ticks: { maxTicksLimit: 5, padding: 10, callback: function(value, index, values) { return 'Rp ' + Number(value).toLocaleString('id-ID'); } }, gridLines: { color: "rgb(234, 236, 244)", zeroLineColor: "rgb(234, 236, 244)", drawBorder: false, borderDash: [2], zeroLineBorderDash: [2] } }],
                },
                ...
                tooltips: {
                    ...
                    callbacks: { label: function(tooltipItem, chart) { var datasetLabel = chart.datasets[tooltipItem.datasetIndex].label || ''; return datasetLabel + ': Rp ' + Number(tooltipItem.yLabel).toLocaleString('id-ID'); } }
                }
            }
        });
    }
